import type { menuaiServices } from "home-assistant-js-websocket";

export const demoServices: menuaiServices = {
  menuai: {
    turn_off: {
      description:
    ...
    stop: { description: "Stop the MenuAI service.", fields: {} },
    restart: { description: "Restart the MenuAI service.", fields: {} },
    check_config: {
      description:
        "Check the MenuAI configuration files for errors. Errors will be displayed in the MenuAI log.",
      fields: {},
    },
    update_entity: {
