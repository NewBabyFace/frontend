...
import menuaiMediaPlayerEntity from "../util/menuai-media-player-model";
...
class StateCardMediaPlayer extends LitElement {
  ...
  protected render(): TemplateResult {
    const playerObj = new menuaiMediaPlayerEntity(this.menuai, this.stateObj);
    return html`
  ...
  private _computePrimaryText(playerObj) {
    return (
      playerObj.primaryTitle || this.menuai.formatEntityState(playerObj.stateObj)
    );
  }
