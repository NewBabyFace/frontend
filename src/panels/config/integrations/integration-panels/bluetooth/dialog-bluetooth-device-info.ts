...
class DialogBluetoothDeviceInfo extends LitElement implements menuaiDialog {
    ...
    return html`
      <ha-dialog
        ...
        .heading=${createCloseHeading(
          this.menuai,
          this.menuai.localize("ui.panel.config.bluetooth.device_information")
        )}
      >
        <p>
          <b>${this.menuai.localize("ui.panel.config.bluetooth.address")}</b>:
          ${this._params.entry.address}
          <br />
          <b>${this.menuai.localize("ui.panel.config.bluetooth.name")}</b>:
          ${this._params.entry.name}
          <br />
          <b>${this.menuai.localize("ui.panel.config.bluetooth.source")}</b>:
          ${this._params.entry.source}
        </p>

        <h3>
          ${this.menuai.localize("ui.panel.config.bluetooth.advertisement_data")}
        </h3>
        <h4>
          ${this.menuai.localize("ui.panel.config.bluetooth.manufacturer_data")}
        </h4>
        <table width="100%">
          <tbody>
        ...
        <h4>${this.menuai.localize("ui.panel.config.bluetooth.service_data")}</h4>
        <table width="100%">
          <tbody>
        ...
        <h4>
          ${this.menuai.localize("ui.panel.config.bluetooth.service_uuids")}
        </h4>
        <table width="100%">
          <tbody>
